            ...
            switch (msg.what) {
               ...
               /* List<ICCMessageManager.DeleteParameter> list = ICCMessageManager.getInstance().getList();
                ...
                case INSERT_MSG_TO_ICC:
                    ...
                    if (obj instanceof ICCMessageManager.DeleteParameter) {
                        ICCMessageManager.DeleteParameter ins = (ICCMessageManager.DeleteParameter) obj;
                        Log.d("ICCMessageManager", " obj instanceof ICCMessageManager.DeleteParameter) arg1 = " + msg.arg1
                                + " body = " + ins.getBodyByKey(msg.arg1 + "") + " rowId = "
                                + String.valueOf(ins.getRowIDByKey(msg.arg1 + "")));
                        int indexOnIcc = getIccManager().copyMessageToIcc(ins.getBodyByKey(msg.arg1 + ""), ins.getAddress(),
                                Long.valueOf(ins.getDateTime()), Integer.valueOf(ins.getSubID()).intValue(),
                                String.valueOf(ins.getRowIDByKey(msg.arg1 + "")), ins.getStatus());
                        getIccManager().syncIndexFromICC(indexOnIcc, String.valueOf(ins.getRowIDByKey(msg.arg1 + "")));
